...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <!--GESTION ASIGNATURAS EDUCACION BACHILLERATO-->
                    ...
                    <form name="asignaturasForm" id="asignaturasForm" method="post">
                        <div class="group-material col-md-8 mb-5 ml-4">
                            ...
                            <select id="cod_nivel_educativo" name="cod_nivel_educativo" class="material-control tooltips-general" data-toggle="tooltip" data-placement="top"
                                ...
                                <option value="PRIMBACH">Primero de Bachillerato</option>
                                <option value="SEGUBACH">Segundo de Bachillerato</option>
                                <option value="TERCBACH">Tercero de Bachillerato</option>
                            </select><br>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text-center">
                                                <a href="GestionAsignaturasBachillerato.php?modificarAsignatura=<?php echo $row ["COD_ASIGNATURA"];?>" class="btn btn-success" type="button">
                                        ...
                                        <td>
                                            <div class="text-center">
                                                <a href="GestionAsignaturasBachillerato.php?eliminarAsignatura=<?php echo $row ["COD_ASIGNATURA"];?>" class="btn btn-danger" role="button">
