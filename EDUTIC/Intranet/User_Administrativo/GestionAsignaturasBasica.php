        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">
                    <a href="#asignaturas" class="btn btn-lg" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="asignaturas" style="margin-right: 20px; color:white; font-size:30px">Asignaturas para Educación Básica Inicial (Segundo a Séptimo de básica)</a>
                </div>
                <div class="row">
