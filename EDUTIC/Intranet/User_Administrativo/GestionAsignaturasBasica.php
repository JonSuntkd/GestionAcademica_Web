...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <!--GESTION ASIGNATURAS EDUCACION BASICA INICIAL-->
        <div class="container-fluid">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text-center">
                                                <a href="GestionAsignaturasBasica.php?modificarAsignatura=<?php echo $row ["COD_ASIGNATURA"];?>" class="btn btn-success" type="button">
                                        ...
                                        <td>
                                            <div class="text-center">
                                                <a href="GestionAsignaturasBasica.php?eliminarAsignatura=<?php echo $row ["COD_ASIGNATURA"];?>" class="btn btn-danger" role="button">
