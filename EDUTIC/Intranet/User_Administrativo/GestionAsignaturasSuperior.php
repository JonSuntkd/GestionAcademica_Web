        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">
                    <a href="#asignaturas" class="btn btn-lg" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="asignaturas" style="margin-right: 20px; color:white;">Asignaturas para Educación Superior (1ero a 3er Curso)</a>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text-center">
                                                <a href="GestionAsignaturasSuperior.php?modificarAsignatura=<?php echo $row ["COD_ASIGNATURA"];?>#asignaturasForm" class="btn btn-success" type="button">
                                        ...
                                        <td>
                                            <div class="text-center">
                                                <a href="GestionAsignaturasSuperior.php?eliminarAsignatura=<?php echo $row ["COD_ASIGNATURA"];?>#asignaturasForm" class="btn btn-danger" role="button">
