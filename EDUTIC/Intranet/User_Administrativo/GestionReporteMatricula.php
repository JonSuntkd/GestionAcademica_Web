<?php 
    ...
    $reporteMatricula = new ReporteServicios();
...
function Header()
{
    ...
    // Title
    $this->Cell(38);
    $this->Cell(100,10,'Reporte Matricula',1,0,'C');
    // Line break
    $this->Ln(15);

    $this->Cell(45,10,"Apellido",1,0,'C',0);
    $this->Cell(45,10,"Nombre",1,0,'C',0);
    $this->Cell(45,10,"Nivel",1,0,'C',0);
    $this->Cell(45,10,"Periodo",1,1,'C',0);;
}
...
$result = $reporteMatricula->matricula();        
...
while($row = $result->fetch_assoc())
{
    ...
    $pdf->Cell(45,10,$row ["COD_NIVEL_EDUCATIVO"],1,0,'C',0);
    $pdf->Cell(45,10,$row ["COD_PERIODO_LECTIVO"],1,1,'C',0);;
}
