<?php 
    ...
    $reporteEdi = new ReporteServicios();
...
function Header()
{
    ...
    // Title
    $this->Cell(38);
    $this->Cell(100,10,'Reporte Periodo',1,0,'C');
    // Line break
    $this->Ln(15);

    $this->Cell(45,10,"Periodo",1,0,'C',0);
    $this->Cell(45,10,"Estado",1,0,'C',0);
    $this->Cell(45,10,"Fecha Inicio",1,0,'C',0);
    $this->Cell(45,10,"Fecha Fin",1,1,'C',0);;
}
...
{
    $pdf->Cell(45,10,$row ["COD_PERIODO_LECTIVO"],1,0,'C',0);
    $pdf->Cell(45,10,$row ["ESTADO"],1,0,'C',0);
