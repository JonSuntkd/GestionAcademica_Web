    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
                <h1 class="all-tittles">EduTic <small>Alumno - Tareas</small></h1>
            </div>
        </div>
        ...
        <div class="container">
            <br><br><div class="" id="message"></div>
                <div class="row mt-2 pb-3">
                    <?php
                        $result2 = $tarea->verificarTarea($cod_alumno);
                                ...
                                <div class="card-deck">
                                    <div class="card p-2 border-secondary mb-2">
                                        ...
                                        <div class="card-body p-1 collapse" id="detallesTarea<?php echo $cont ?>">
                                            <h1 class="card-title text-center text-info"><?= $row["TITULO_TAREA"] ?></h1>
                                            <h2 class="card-text text-center text-danger"><?php echo $row["DETALLE_TAREA"] ?></h2>
                                            <h3 class="card-text text-center text-success"><?php echo $row["FECHA_ENTREGA"] ?></h3>
                                            <a href="../assets/files/<?php echo $row['ARCHIVO'] ?>" download="<?php echo $row['ARCHIVO'] ?>" class="btn btn-success" role="button">
                                                Descargar Archivo
                                            </a>
                                            <a href="UserAlumnoTareas.php?finalizarTarea=<?php echo $row ["COD_TAREA"];?>" class="btn btn-danger" role="button">
                                                Tarea Finalizada
                                            </a>
                                        </div>
                                    </div>
