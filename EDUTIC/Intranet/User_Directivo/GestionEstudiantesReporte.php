    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
                <h1 class="all-tittles">EduTic <small>Reporte de Estudiantes</small></h1>
            </div>
        </div>
        <div class="container-fluid" style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección donde puede encontrar reportes de los estudiantes registrados<br>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Reporte de estudiantes y representantes</li>
                    </ol>
                </div>
            </div>
        </div>
