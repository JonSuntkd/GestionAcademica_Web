...
<div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Listado de Personas</div>
                <form id="aspirantes" method="post" action="GestionReportePerExcel.php">
                    <div class="row container-flat-form">
                        ...
                        <center>
                        <input value="Exportar a Excel" type="submit" name="generar_reporte">
                         </center>                  
                    </div>
                ...
                <form id="aspirantes" method="post" action="GestionReportePersonaPdf.php">
                  <center>
                   <input value="Mirar en PDF" type="submit" name="generar_reporte">
                   </center>                    
                </form>  
