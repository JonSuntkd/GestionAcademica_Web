        ...
        <section class="full-reset text-center" style="padding: 40px 0;">
						<div class="ml-auto">
							...
							<table class="table" border="1">
								...
								<?php
								$result = $conexion->query("SELECT * FROM USUARIO U, ROL_USUARIO R, PERSONA P, ROL S");
								if ($result->num_rows > 0) {
									while($row = $result->fetch_assoc()) {
								
								?>
								<tr>
									<td><a href="index.php<?php echo $_SESSION['user']['NOMBRE']?>"><?php echo $_SESSION['user']['NOMBRE']?></a></td>
