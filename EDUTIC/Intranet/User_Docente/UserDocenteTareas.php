    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
                <h1 class="all-tittles">EduTic <small> Docente - Tareas</small></h1>
            </div>
        </div>
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Registre las distintas tareas a ser enviadas a los estudiantes.                
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
                <div class="container-flat-form">
                    <div class="title-flat-form title-flat-blue">Registrar Nueva Tarea</div>
                ...
                ?>
                    <form action="" method="post" id="registroTareas" name="registroTareas" enctype="multipart/form-data">
                        ...
                        <div class="group-material col-xs-12 col-sm-8 col-sm-offset-2">
                            <input type="text" class="material-control tooltips-general" placeholder="Título de la tarea" required="" 
                                    data-toggle="tooltip" data-placement="top" title="Escriba el título de la tarea a realizar" 
                                    name="titulo_tarea">
                        ...
                        <div class="group-material col-xs-12 col-sm-8 col-sm-offset-2">
                            <input type="text" class="material-control tooltips-general" placeholder="Detalles de la tarea" required="" 
                                    data-toggle="tooltip" data-placement="top" title="Escriba los detalles de la tarea a realizar" 
                                    name="detalle_tarea">
                            <span class="highlight"></span>
                            <span class="bar"></span>
                        </div><br><br><br><br>
                        ...
                        <div class="group-material col-xs-12 col-sm-8 col-sm-offset-2">
                            <input type="datetime-local" class="material-control tooltips-general" placeholder="Fecha de Entrega" required="" 
                                    data-toggle="tooltip" data-placement="top" title="Seleccione la fecha de entrega" 
                                    name="fecha_entrega" onchange="obtenerFecha(this)">
                            <span class="highlight"></span>
                            <span class="bar"></span>
                        </div><br><br><br><br>
                        <h1 class="all-tittles">Archivos</h1>
                        <div class="group-material col-xs-12 col-sm-8 col-sm-offset-2">
                            <input type="file" class="material-control tooltips-general" placeholder="Archivos para la tarea" required="" 
            ...
            <?php
                    if(isset($_POST['accionTareas'])&& ($_POST['accionTareas']=='Hecho'))
                    {
                        ...
                        $tarea->ingresarTarea($_POST['cod_nivel_educativo'],$_POST['cod_asignatura'],$_POST['cod_periodo_lectivo'],
                                                     $_POST['cod_paralelo'],$cod_docente,$_POST['titulo_tarea'],$_POST['detalle_tarea'],
                                                     $_POST['fecha_entrega'],$archivoTarea);
                    }
            ?>
