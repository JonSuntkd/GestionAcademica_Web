<?php 
    ...
    $datos = $calificacion->datosEstudiante($cod_representante);
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
                <h1 class="all-tittles">EduTic <small>Representante - Calificaciones del Estudiante</small></h1>
            </div>
        </div>
        ...
        <section class="full-reset text-center" style="padding: 40px 0;">
            <div class="container-fluid">
                <div class="container-flat-form">
                    <div class="title-flat-form title-flat-blue">Verificar Notas Quimestrales de <?php echo $nombre  ?>&nbsp;<?php echo $apellido ?></div>
            ...
            ?> 
                    <div class="table-responsive">
                        <table id="tablaEstudiantesCalificaciones" class="table-striped table-bordered table-condensed" style="width: 100%;">
                               ...
                               <tbody>
                                    <?php
                                        $result = $calificacion->calificacionGeneral1($codigo_estudiante,$periodo);
            ...
            ?> 
                    <div class="table-responsive">
                        <table id="tablaEstudiantesCalificaciones" class="table-striped table-bordered table-condensed" style="width: 100%;">
                               ...
                               <tbody>
                                    <?php
                                        $result = $calificacion->calificacionGeneral2($codigo_estudiante,$periodo);
                                        if($result->num_rows>0)
                                        {
                                            while($row = $result->fetch_assoc())
                                            {    
