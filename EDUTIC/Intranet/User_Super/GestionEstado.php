    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">EduTic <small>Gestión de Estado</small></h1>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Modificación Estado de Usuario </div>
                <form>
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Código de Usuario" required="" data-toggle="tooltip" data-placement="top" title="Escriba el Código de Usuario">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Código de Usuario</label>
                            </div>
                            <div class="selectUser">
                                <p style="color: rgb(212, 11, 11);" class="group-material" >Escoja el Estado del Usuario:</p>
                                <select name="rol" class="group-material">
                                    <option value= "seleccion" disabled selected> > Estado de Usuario</option>
                                    <option value="Usuario Directivo">Activo</option>
                                    <option value="Usuario Administrativo">Pasivo</option>
                                </select>
                            </div>
                            <br>
                            <p class="text-center">
